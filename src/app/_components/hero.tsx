            ...
            <div className="container mx-auto pt-16 pb-16 md:pb-0 px-4 relative">
                ...
                <article className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div className="space-y-6">
                        ...
                        <p className=" lg:text-lg" data-aos="fade_right">
                            Encontre o melhor serviço de pet shop para o seu animal de estimação.
                        </p>

                            <a
                            data-aos="fade_up" 
                            href="#" className="bg-green-500 px-5 py-2 rounded-md font-semibold flex items-center
